@extends('livewire.emails.layouts.master')
...
<div class="container-sec">
    <div class="text-center">
        ...
        <h2 style="text-align: center">به سامانه مجموعه ابزار کد خوش آمدید</h2>
        <div class="otp-code">{{ $details['body'] }}</div>
    </div>
    <div class="footer-text">
        <p>ممنون از شما<br>ابزار کد</p>
    </div>
</div>
